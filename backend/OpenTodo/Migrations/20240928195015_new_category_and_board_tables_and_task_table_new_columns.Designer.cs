...
namespace OpenTodo.Migrations
{
    ...
    [Migration("20240928195015_new_category_and_board_tables_and_task_table_new_columns")]
    partial class new_category_and_board_tables_and_task_table_new_columns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenTodo.Models.TaskSchema", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 28, 19, 50, 14, 896, DateTimeKind.Utc).AddTicks(3224));
